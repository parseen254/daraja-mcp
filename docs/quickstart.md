# Quickstart: a working M-Pesa payment in 60 seconds
...
Other clients: [clients.md](clients.md).
...
- Point it at the real sandbox: [sandbox.md](sandbox.md)
- Go to production: [going-live.md](going-live.md)
